...
class StrayLightLoader(LoaderABC[PUNCHCube]):
    def __init__(self, path: str):
        self.path = path

    def gen_key(self) -> str:
        return f"sl-{os.path.basename(self.path)}-{os.path.getmtime(self.path)}"
